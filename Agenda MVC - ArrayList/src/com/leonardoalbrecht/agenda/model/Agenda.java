...
import com.leonardoalbrecht.agenda.view.Tela;
...
public class Agenda {
	...
	private void buscarContato(Tela tela) {
	  ...
	  private void editarContato(Tela tela) {
	        ...
	        // variÃ¡vel onde o ID informado serÃ¡ guardado
	        int id;

	        // Pede para informar um ID para ediÃ§Ã£o do contato e tranformar o valor em um int
	        id = Integer.parseInt(JOptionPane.showInputDialog(null, "Informe o Id do usuario que deseja editar", "Editar Contato", 1));

	        // Pede novas informaÃ§Ãµes para que as informaÃ§Ãµes antigas do usuarios sejam reescritas
	    ...
	    } // fecha o mÃ©todo editarContato()

	     private void contatoEditado(Contato contato, int id) {

	         // rescreve o metodos da informaÃ§Ã£o do usuario registrado
	     ...
	     } // Final do mÃ©todo contatoEditado()

	     private void deletarContato(Tela tela) {

	         buscarContato(tela);

	         // variÃ¡vel onde o valor do ID infomado Ã© guardado
	         int idClear;
